        ...
        <>
            {isOpen && (
                <>
                    ...
                    <div className='fixed top-1/2 transition-all duration-300 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white border border-gray-300 z-50 w-[60%] xl:w-[50%] rounded-md h-[75%]'>
                        <div
